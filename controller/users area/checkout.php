...
<html lang="en">
    ...
    <body style="background: url('../product_images/bg.jpg');">
        <!------------------navbar--------------------------->
        <div class="container-fluid p-0">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 mr-lg-0">
                        <li class="nav-item nbar">
                            <a class="nav-link nav active text-white" aria-current="page" href="../../view/index.php"><h5>Home</h5></a>
                        </li>
                        <li class="nav-item nbar">   
                            <a class="nav-link nav" href="../../view/display_all.php"><h5>Products</h6></a>
                        </li>
                        <li class="nav-item nbar">
                            <a class="nav-link nav" href="user_registration.php"><h5>Register</h6></a>
                        </li>   
                        <li class="nav-item nbar">
            ...
            <nav style="background-color:rgb(106,78,120);" class="navbar navbar-expand-lg navbar-dark text-dark">
                ...
                <?php
                        ...
                        if (!isset($_SESSION['username'])) {
                            ...
                            echo "<li class='nav-item'>
                                    <a class='nav-link fs-5 log-bar text-white' href='logout.php'>Logout</a>
                                </li>";
                        }
                    ?>
            ...
            <!-------------last segment--------------------->
            <div class="bg-dark py-2 fs-5 m-1 text-center">
